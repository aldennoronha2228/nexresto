...
const tableStatusConfig: Record<Table['status'], { color: string; border: string; text: string }> = {
    ...
    pending_payment: { color: 'bg-violet-50', border: 'border-violet-400', text: 'text-violet-700' },
};
